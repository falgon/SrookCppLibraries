...
template <class T>
struct is_safe_default_constructible<T, true> : public integral_constant<bool, is_array_known_bounds<T>::value && 
	is_default_constructible_atom<typename remove_all_extents<T>::type>::value
> {};
