...
struct is_base_to_derived_reference<From, To, true> {
	...
	typedef integral_constant<bool,
			(!is_same<src_type, dst_type>::value) && 
				is_base_of<src_type, dst_type>::value && 
				(!is_constructible<dst_type, From>::value)> type;
...
struct is_direct_constructible_reference_cast : public integral_constant<bool,
	is_static_castable<Arg, T>::value && 
	!(is_base_to_derived_reference<Arg, T>::value || is_lvalue_to_rvalue_reference<Arg, T>::value)> {};
