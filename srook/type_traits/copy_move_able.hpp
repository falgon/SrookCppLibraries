...
template <class _Tp>
    struct copy_f_deleted < _Tp,
    typename copy_signature < _Tp, &_Tp::operator=> ::type> : std::true_type {
};
template <class _Tp>
...
template <class _Tp>
    struct move_f_deleted < _Tp,
    typename move_signature < _Tp, &_Tp::operator=> ::type> : std::true_type {
};
template <class _Tp>
