...
#ifndef INCLUDED_SROOK_RANGE_PIPE_ALGORITHM_SET_SYMMETRIC_DIFFERENCE_HPP
#define INCLUDED_SROOK_RANGE_PIPE_ALGORITHM_SET_SYMMETRIC_DIFFERENCE_HPP
...
struct set_symmetric_difference_t{
	...
	explicit constexpr set_symmetric_difference_t(InputIterator first,InputIterator last,OutputIterator oiter)
	...
	>
	explicit constexpr set_symmetric_difference_t(Range&& r,OutputIterator oiter)
	...
	{
		return std::set_symmetric_difference(r.begin(),r.end(),std::move(first_),std::move(last_),std::move(oiter_));
	}
protected:
...
struct set_symmetric_difference_compare_t final:set_symmetric_difference_t<InputIterator,OutputIterator>{
	using set_symmetric_difference_t<InputIterator,OutputIterator>::set_symmetric_difference_t;

	template<
		REQUIRES(!has_iterator_v<InputIterator> and !has_iterator_v<OutputIterator> and is_callable_v<Compare>)
	>
	explicit constexpr 
	set_symmetric_difference_compare_t(InputIterator first,InputIterator last,OutputIterator oiter,Compare comp)
		:set_symmetric_difference_t<InputIterator,OutputIterator>::set_symmetric_difference_t(
	...
	>
	explicit constexpr
	set_symmetric_difference_compare_t(Range&& r,OutputIterator oiter,Compare comp)
		:set_symmetric_difference_t<InputIterator,OutputIterator>::set_symmetric_difference_t(r.begin(),r.end(),std::move(oiter)),
		comp_(std::move(comp))
	{}
...
>
constexpr set_symmetric_difference_t<
	std::remove_reference_t<std::remove_cv_t<InputIterator>>,
	std::remove_reference_t<std::remove_cv_t<OutputIterator>>
>
set_symmetric_difference(InputIterator first,InputIterator last,OutputIterator oiter)
{
	return set_symmetric_difference_t<
		std::remove_reference_t<std::remove_cv_t<InputIterator>>,
		std::remove_reference_t<std::remove_cv_t<OutputIterator>>
...
>
set_symmetric_difference(Range&& r,OutputIterator oiter)
{
	return set_symmetric_difference_t<
...
>
constexpr set_symmetric_difference_compare_t<
	std::remove_reference_t<std::remove_cv_t<InputIterator>>,
	std::remove_reference_t<std::remove_cv_t<OutputIterator>>,
	std::remove_reference_t<std::remove_cv_t<Compare>>
>
set_symmetric_difference(InputIterator&& first,InputIterator&& last,OutputIterator oiter,Compare&& comp)
{
	return set_symmetric_difference_compare_t<
		std::remove_reference_t<std::remove_cv_t<InputIterator>>,
		std::remove_reference_t<std::remove_cv_t<OutputIterator>>,
		std::remove_reference_t<std::remove_cv_t<Compare>>
	>(
...
constexpr set_symmetric_difference_compare_t<
	...
	std::remove_reference_t<std::remove_cv_t<Compare>>
>
set_symmetric_difference(Range&& r,OutputIterator&& oiter,Compare&& comp)
{
	return set_symmetric_difference_compare_t<
		typename std::remove_reference_t<std::remove_cv_t<Range>>::const_iterator,
		std::remove_reference_t<std::remove_cv_t<OutputIterator>>,
...
using detail::set_symmetric_difference;
