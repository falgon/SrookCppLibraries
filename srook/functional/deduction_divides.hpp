...
struct deduction_divides {
    ...
    const SROOK_NOEXCEPT((typename std::common_type<first_argument_type, second_argument_type>::type(lhs) / typename std::common_type<first_argument_type, second_argument_type>::type(rhs)))
    {
