...
#	include <tuple>
#	define SROOK_PP_VA_ARGS_SIZE(...) (SROOK_ATTRIBUTE_UNUSED std::tuple_size<decltype(std::tie(__VA_ARGS__))>::value)
#else
#	define SROOK_PP_VA_ARGS_SIZE(...) (SROOK_ATTRIBUTE_UNUSED (sizeof((char[]){__VA_ARGS__})/sizeof(char)))
#endif
