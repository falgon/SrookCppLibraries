...
void
#endif
bubble_sort(ForwardIter first, ForwardIter last, Compare comp)
SROOK_NOEXCEPT(
...
#endif
SROOK_FORCE_INLINE void bubble_sort(ForwardIter first, ForwardIter last)
SROOK_NOEXCEPT(srook::algorithm::bubble_sort(first, last, srook::functional::deduction_less()))
{
#ifdef __GNU_LIBRARY__
    __glibcxx_function_requires(_ForwardIteratorConcept<ForwardIter>)
#endif
    srook::algorithm::bubble_sort(first, last, srook::functional::deduction_less());
}
