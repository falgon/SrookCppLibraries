...
public:
    ...
    static SROOK_CONSTEXPR std::size_t round_size = srook::hash::detail::round_64.size();
    static SROOK_CONSTEXPR srook::array<value_type, round_size> round_constant = srook::hash::detail::round_64;
...
public:
    ...
    static SROOK_CONSTEXPR std::size_t round_size = srook::hash::detail::round_32.size();
    static SROOK_CONSTEXPR srook::array<value_type, round_size> round_constant = srook::hash::detail::round_32;
    static SROOK_CONSTEXPR srook::array<value_type, CHAR_BIT> init_hash = {
