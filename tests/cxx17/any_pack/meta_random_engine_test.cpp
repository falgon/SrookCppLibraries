...
BOOST_AUTO_TEST_CASE(mersenne_twister_test)
{
    ...
    const auto anypack_mt19937 = srook::any_pack<>::make_random_sequence<10, srook::vmpl::random::mt19937<>>::range<std::vector>;
    const auto anypack_mt19937_64 = srook::any_pack<>::make_random_sequence<10, srook::vmpl::random::mt19937_64<>>::range<std::vector>;
