...
void linear(F &&disp) noexcept
{
    ...
    srook::for_each(minstd_rand0_type_25seq::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    srook::for_each(minstd_rand_type_25seq::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    ...
    srook::for_each(between_0_to_100_random_50seq_linear::template constant_range<std::tuple>, [](const auto &x) { std::cout << x << " "; });
    std::cout << std::endl;
...
void xorshift(F &&disp) noexcept
{
    ...
    srook::for_each(XOR32::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    srook::for_each(XOR64::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    srook::for_each(XOR96::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    srook::for_each(XOR128::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    ...
    srook::for_each(between_0_to_100_random_50seq_xor::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
...
void mersenne_twister(F &&disp) noexcept
{
    ...
    srook::for_each(mt11213b_type::template constant_range<std::tuple>, disp);
    std::cout << std::endl;

    using mt19937_type = srook::any_pack<>::make_random_sequence<25, srook::random::mt19937<>>;
    srook::for_each(mt19937_type::template constant_range<std::tuple>, disp);
    std::cout << std::endl;

    using mt19937_64_type = srook::any_pack<>::make_random_sequence<25, srook::random::mt19937_64<>>;
    srook::for_each(mt19937_64_type::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
    ...
    srook::for_each(between_0_to_100_random_10seq_mt::template constant_range<std::tuple>, disp);
    std::cout << std::endl;
